...
public interface IOfferService
{
	...
	Task<RentalTransactionIdWithDateTimesDto?> ChooseOfferAsync(int providerId, string offerId, ChooseOfferDto chooseOfferDto, CancellationToken cancellationToken = default);
}
