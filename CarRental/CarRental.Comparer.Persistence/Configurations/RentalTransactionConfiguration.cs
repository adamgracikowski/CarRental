...
public sealed class RentalTransactionConfiguration : IEntityTypeConfiguration<RentalTransaction>
{
	public void Configure(EntityTypeBuilder<RentalTransaction> builder)
	{
		...
		builder.Property(rt => rt.Description)
			.HasMaxLength(ConfigurationConstants.RentalTransactionConstants.DescriptionMaxLength);

		builder.Property(rt => rt.Image)
			.HasMaxLength(ConfigurationConstants.RentalTransactionConstants.ImageMaxLength);
